...
COPY: dict[str, dict] = {
    "en": {
        ...
        "cta": "Scan",
        "advanced_label": "Your information is required for the site report",
    ...
    "es": {
        ...
        "cta": "Analizar",
        "advanced_label": "Tu información es necesaria para el reporte del sitio",
    ...
    "fr": {
        ...
        "cta": "Analyser",
        "advanced_label": "Vos informations sont nécessaires pour le rapport du site",
